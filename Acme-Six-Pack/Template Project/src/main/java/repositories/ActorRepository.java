...
public interface ActorRepository extends JpaRepository<Actor, Integer>{
	 ...
	 * contenidos en las carpetas con nombre 'spam box' y sean carpetas del sistema. 
	 * Agrupamos el resultado por emisor, quedándonos con aquel grupo cuyo número de 
	 * mensajes que cumplen la condición antes citada sea mayor igual que todos los 
	 * grupos que devuelve la consulta.
	 * */
	...
	/*
	 * Cantidad de mensajes de spam enviados por el actor que más spam ha enviado.
	 * */
